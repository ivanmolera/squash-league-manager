  ...
  return (
    <main className="auth-shell">
      ...
      <section className="auth-panel">
        ...
        <h1>{t.resendVerificationTitle}</h1>
        <p className="muted">{t.resendVerificationText}</p>
        <EmailRequestForm
          action={resendVerificationEmailAction}
          labels={{ email: t.email, submit: t.resendVerification, submitting: t.creatingAccount }}
        />
