    ...
    "ca": {
        ...
        "roles": [
            ("Jugador", [
                ...
                "Pot sol·licitar unir-se a un club des de la seva fitxa. De moment només pot pertànyer a un club per temporada; si el club no té responsable, la sol·licitud queda per a gestió admin.",
            ...
            ("Administrador", [
                ...
                "Pot gestionar sol·licituds d'alta a clubs que encara no tenen responsable assignat.",
    ...
    "es": {
        ...
        "roles": [
            ("Jugador", [
                ...
                "Puede solicitar unirse a un club desde su ficha. Por ahora solo puede pertenecer a un club por temporada; si el club no tiene responsable, la solicitud queda para gestión admin.",
            ...
            ("Administrador", [
                ...
                "Puede gestionar solicitudes de alta a clubs que todavía no tienen responsable asignado.",
    ...
    "en": {
        ...
        "roles": [
            ("Player", [
                ...
                "Can request to join a club from their profile. For now, a player can belong to only one club per season; if the club has no responsible person, the request is handled by admins.",
            ...
            ("Admin", [
                ...
                "Can manage club join requests for clubs that do not yet have an assigned responsible person.",
